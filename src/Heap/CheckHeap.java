...
public class CheckHeap {
	...
	public boolean isMinHeap(int [] heap){
		...
		//so it means that if node with index i -> 2*i+2 > N where is the size of the array then
		//we know that it is a leaf node
		//rearrange the question: (size of the array without leaf nodes) = (N-2)/2 this is the effective
